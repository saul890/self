...
const imageTen = document.getElementById('imageTen');
...
imageTwo.addEventListener('click', function onClick(event) {
  imageThree.style.display = 'block';
});

imageThree.addEventListener('click', function onClick(event) {
  imageFour.style.display = 'block';
  imageTwo.style.top = '100px';
  imageThree.style.top = '200px';
});
...
image30.addEventListener('click', function onClick(event) {
  image40.style.display = 'block';
});
image39.addEventListener('click', function onClick(event) {
  image40.style.display = 'block';
});
image40.addEventListener('click', function onClick(event) {
  image41.style.display = 'block';
});

image41.addEventListener('click', function onClick(event) {
  image42.style.display = 'block';
});

image42.addEventListener('click', function onClick(event) {
  image43.style.display = 'block';
});

image43.addEventListener('click', function onClick(event) {
  image44.style.display = 'block';
});

image44.addEventListener('click', function onClick(event) {
...
imageFive.addEventListener('click', function onClick(event) {
  imageSix.style.display = 'block';
});

imageSix.addEventListener('click', function onClick(event) {
